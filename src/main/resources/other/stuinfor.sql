...
Source Database       : stuinfor

Target Server Type    : MYSQL
Target Server Version : 60011
File Encoding         : 65001

Date: 2019-05-21 13:04:12
*/
...
CREATE TABLE `attendance_info` (
  ...
  `attendance_xuenian` varchar(100) DEFAULT NULL,
  `attendance_xueqi` varchar(100) DEFAULT NULL,
  `attendance_month` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`attendance_id`),
  KEY `FK_Reference_22` (`student_id`),
  KEY `staff_id` (`staff_id`),
  CONSTRAINT `attendance_info_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student_info` (`student_id`),
  CONSTRAINT `attendance_info_ibfk_2` FOREIGN KEY (`staff_id`) REFERENCES `staff_info` (`staff_id`)
...
CREATE TABLE `audition_info` (
  ...
  CONSTRAINT `audition_info_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student_info` (`student_id`)
...
CREATE TABLE `class_info` (
  ...
  `class_major` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`class_id`),
  KEY `FK_Reference_18` (`syllabus_id`),
  KEY `FK_Reference_19` (`classroom_id`),
  KEY `FK_Reference_20` (`staff_id`),
  CONSTRAINT `class_info_ibfk_2` FOREIGN KEY (`syllabus_id`) REFERENCES `syllabus_info` (`syllabus_id`),
  CONSTRAINT `class_info_ibfk_3` FOREIGN KEY (`classroom_id`) REFERENCES `classroom_info` (`classroom_id`),
  CONSTRAINT `class_info_ibfk_4` FOREIGN KEY (`staff_id`) REFERENCES `staff_info` (`staff_id`)
...
CREATE TABLE `class_transaction_info` (
  ...
  CONSTRAINT `class_transaction_info_ibfk_1` FOREIGN KEY (`class_id`) REFERENCES `class_info` (`class_id`)
...
CREATE TABLE `communicate_info` (
  ...
  `student_id` int(11) DEFAULT NULL,
  `staff_id` int(11) DEFAULT NULL,
  `communicate_time` datetime DEFAULT NULL COMMENT '评价时间',
  `communicate_content` varchar(2000) DEFAULT NULL COMMENT '评价内容',
  `communicate_xuenian` varchar(100) DEFAULT NULL,
  `communicate_xueqi` varchar(100) DEFAULT NULL,
  `leave_count` int(11) DEFAULT NULL COMMENT '病事假统计',
  `truancy_count` int(11) DEFAULT NULL COMMENT '旷课统计',
  `reward_punish` varchar(2000) DEFAULT NULL COMMENT '奖惩记载',
  PRIMARY KEY (`communicate_id`),
  KEY `FK_Reference_12` (`student_id`),
  KEY `FK_Reference_13` (`staff_id`),
  CONSTRAINT `communicate_info_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student_info` (`student_id`),
  CONSTRAINT `communicate_info_ibfk_2` FOREIGN KEY (`staff_id`) REFERENCES `staff_info` (`staff_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
...
CREATE TABLE `discipline_info` (
  ...
  `discipline_no` varchar(50) DEFAULT NULL,
  `discipline_name` varchar(100) DEFAULT NULL,
  `discipline_tuition` double(11,2) DEFAULT NULL COMMENT '学分',
  `discipline_bring` int(11) DEFAULT NULL,
  `discipline_type` varchar(50) DEFAULT NULL,
...
CREATE TABLE `email_info` (
  ...
  CONSTRAINT `email_info_ibfk_1` FOREIGN KEY (`staff_id`) REFERENCES `staff_info` (`staff_id`)
...
CREATE TABLE `evaluation_info` (
  ...
  `staff_id` int(11) DEFAULT NULL,
  `class_id` int(11) DEFAULT NULL,
  `evaluation_xueqi` varchar(100) DEFAULT NULL,
  `evaluation_month` varchar(50) DEFAULT NULL,
  `evaluation_major` varchar(100) DEFAULT NULL,
  ...
  `evaluation_note` varchar(2000) DEFAULT NULL,
  PRIMARY KEY (`evaluation_id`),
  KEY `FK_Reference_11` (`student_id`),
  KEY `discipline_id` (`discipline_id`),
  KEY `staff_id` (`staff_id`),
  KEY `class_id` (`class_id`),
  CONSTRAINT `evaluation_info_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student_info` (`student_id`),
  CONSTRAINT `evaluation_info_ibfk_2` FOREIGN KEY (`discipline_id`) REFERENCES `discipline_info` (`discipline_id`),
  CONSTRAINT `evaluation_info_ibfk_3` FOREIGN KEY (`staff_id`) REFERENCES `staff_info` (`staff_id`),
  CONSTRAINT `evaluation_info_ibfk_4` FOREIGN KEY (`class_id`) REFERENCES `class_info` (`class_id`)
...
CREATE TABLE `evaluation_xueqi` (
  ...
  `class_id` int(11) DEFAULT NULL,
  `evaluation_xueqi` varchar(100) DEFAULT NULL,
  `evaluation_month` varchar(100) DEFAULT NULL,
  `evaluation_major` varchar(100) DEFAULT NULL,
  `evaluation_content` varchar(200) DEFAULT NULL,
  `evaluation_time` datetime DEFAULT NULL,
  `evaluation_note` varchar(2000) DEFAULT NULL,
  PRIMARY KEY (`evaluation_id`),
  KEY `FK_Reference_11` (`student_id`),
  ...
  KEY `staff_id` (`staff_id`),
  KEY `class_id` (`class_id`),
  CONSTRAINT `evaluation_xueqi_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student_info` (`student_id`),
  CONSTRAINT `evaluation_xueqi_ibfk_2` FOREIGN KEY (`discipline_id`) REFERENCES `discipline_info` (`discipline_id`),
  CONSTRAINT `evaluation_xueqi_ibfk_3` FOREIGN KEY (`staff_id`) REFERENCES `staff_info` (`staff_id`),
  CONSTRAINT `evaluation_xueqi_ibfk_4` FOREIGN KEY (`class_id`) REFERENCES `class_info` (`class_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
...
CREATE TABLE `market_active` (
  ...
  CONSTRAINT `market_active_ibfk_1` FOREIGN KEY (`staff_id`) REFERENCES `staff_info` (`staff_id`)
...
CREATE TABLE `messafe_info` (
  ...
  CONSTRAINT `messafe_info_ibfk_1` FOREIGN KEY (`staff_id`) REFERENCES `staff_info` (`staff_id`)
...
CREATE TABLE `notice_info` (
  ...
  `notice_filename` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`notice_id`),
  KEY `FK_Reference_7` (`staff_id`),
  CONSTRAINT `notice_info_ibfk_1` FOREIGN KEY (`staff_id`) REFERENCES `staff_info` (`staff_id`)
...
CREATE TABLE `staff_info` (
  ...
  CONSTRAINT `staff_info_ibfk_1` FOREIGN KEY (`role_id`) REFERENCES `role_info` (`role_id`)
) ENGINE=InnoDB AUTO_INCREMENT=82 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of staff_info
-- ----------------------------
INSERT INTO `staff_info` VALUES ('10', '1', '杨经理', '男', '25', '江西', '3625281979X8432', '1982-09-16 00:00:00', '0791-87875656', '13872051811', '1254567883@qq.com', '江西南昌', '434342315', '2016-09-13 00:00:00', '本科', '网站总管    ', '2', 'yangfanrong', 'admin089');
INSERT INTO `staff_info` VALUES ('13', '2', '许雪龙', '男', '33', '江西', '346565645666666', '1988-09-16 00:00:00', '0791-87875656', '13856563235', '34545999xx@qq.com', '江西南昌', '454767878', '2015-07-03 00:00:00', '专科', '    ', '1', 'xuxuelong', '123');
INSERT INTO `staff_info` VALUES ('18', '3', '张小英', '女', '24', '江西', '4546576576876', '1989-09-16 00:00:00', '0791-85653435', '13787323434', '7232376543@qq.com', '江西南昌', '232342423', '2018-07-02 00:00:00', '本科', ' ', '3', 'zhangxiaoying', '123');
INSERT INTO `staff_info` VALUES ('19', '4', '李创', '男', '37', '安徽', '5001420193434448', '1981-09-16 00:00:00', '0791-87875656', '13998945778', '3434354763@qq.com', '江西南昌', '5657687666', '2016-07-13 00:00:00', '硕士', '    ', '2', 'lichuang', '123');
INSERT INTO `staff_info` VALUES ('20', '2', '郭立强', '男', '37', '内蒙古', '768888888888888', '1982-06-02 00:00:00', '0791-87875656', '13878978978', '234243@qq.com', '江西南昌', '67879567567', '2018-07-03 00:00:00', '专科', '   ', '1', 'guoliqiang', '123');
INSERT INTO `staff_info` VALUES ('23', '4', '黎子强', '男', '34', '江西', '23422242348888', '2018-07-04 00:00:00', '0791-87875656', '13767689978', 'sdfdsf@136.com', '江西高安', '3543543534', '2018-07-03 00:00:00', '本科', '           ', '2', 'liziqiang', '123');
INSERT INTO `staff_info` VALUES ('25', '4', '毛敏', '女', '30', '江西', '45666593454656', '2018-08-22 00:00:00', '0791-65675787', '13657687689', '355459999@qq.com', '江西南昌', '6789879079', '2017-07-20 00:00:00', '硕士', ' ', '2', 'maomin', '123');
INSERT INTO `staff_info` VALUES ('26', '4', '谭时明', '男', '35', '江西', '92034543564568', '2018-08-08 00:00:00', '0791-87875656', '13576057878', 'sdfdsf@136.com', '江西南昌', '6789879079', '2018-07-19 00:00:00', '本科', '2sd ', '2', 'tanshiming', '123');
INSERT INTO `staff_info` VALUES ('27', '4', '黄娟', '女', '36', '浙江', '93456576578868', '1994-06-30 00:00:00', '0791-34355657', '13657687689', '12xxxx3@qq.com', '江西南昌', '67879567567', '2016-07-06 00:00:00', '本科', '', '2', 'huangjuan', '123');
INSERT INTO `staff_info` VALUES ('28', '4', '万坤', '男', '28', '天津', '23422242348888', '1984-07-05 00:00:00', '0791-87855456', '13787323434', 'wefdsfa@126.com', '江西南昌', '5657687666', '2017-08-01 00:00:00', '硕士', '  ', '2', 'wankun', '123');
INSERT INTO `staff_info` VALUES ('29', '4', '龚霞', '女', '26', '北京', '23422242348888', '2018-08-01 00:00:00', '0791-87873456', '13576567889', '12xxxx3@qq.com', '江西南昌', '67879567567', '2018-08-08 00:00:00', '博士', '   ', '2', 'gongxia', '123');
INSERT INTO `staff_info` VALUES ('30', '4', '刘红', '女', '25', '江西', '23422242348888', '1986-07-30 00:00:00', '0791-87875656', '13657687689', '12xxxx3@qq.com', '江西南昌', '67879567567', '2016-08-09 00:00:00', '硕士', '  ', '2', 'liuhong', '123');
INSERT INTO `staff_info` VALUES ('31', '4', '袁耀', '男', '31', '江西', '2342224234656575757', '1985-07-31 00:00:00', '0791-87843456', '13576567889', '234243@qq.com', '江西南昌', '67879567567', '2018-08-16 00:00:00', '专科', ' sdfasfad ', '2', 'yuanyao', '123');
INSERT INTO `staff_info` VALUES ('32', '4', '罗园菁', '女', '35', '安徽', '3625281979XXXXXXXX', '2018-08-03 00:00:00', '0791-87875656', '13787323434', '212323@qq.com', '江西南昌', '6789879079', '2018-08-03 00:00:00', '博士', ' ', '2', 'luoyuanjing', '123');
INSERT INTO `staff_info` VALUES ('33', '3', '王倩倩', '女', '25', '江西', '3625281979XXXXXXXX', '2018-08-08 00:31:49', '0791-87434556', '13787323434', '355459999@qq.com', '江西南昌', '232342423', '2016-08-11 00:00:00', '硕士', ' ', '3', 'wangqianqian', '123');
INSERT INTO `staff_info` VALUES ('34', '4', '王晖', '女', '35', '天津', '2333333333333', '2018-08-08 00:00:00', '0791-87875656', '13787323434', '12xxxx3@qq.com', '江西南昌', '323234323', '2017-08-01 00:00:00', '本科', '   ', '2', 'wanghui', '123');
INSERT INTO `staff_info` VALUES ('35', '4', '徐超', '男', '35', '江西', '2342224234656575757', '2018-08-08 00:31:49', '0791-65675787', '13787323434', '355459999@qq.com', '江西南昌', '67879567567', '2017-08-08 00:00:00', '博士', '  ', '2', 'xuchao', '123');
INSERT INTO `staff_info` VALUES ('36', '4', '梁江海', '男', '35', '天津', '3625281979XXXXXXXX', '2018-08-08 00:31:49', '0791-87875656', '13576567889', 'wefdsfa@126.com', '江西南昌', '67879567567', '2017-07-31 00:00:00', '本科', '  ', '2', 'liangjianghai', '123');
INSERT INTO `staff_info` VALUES ('37', '4', '郑川', '女', '35', '江西', '2333333333333', '2018-08-08 00:31:49', '0791-87875656', '13787323434', '24243242@qq.com', '江西南昌', '454767878', '2017-09-07 00:00:00', '硕士', '  ', '2', 'zhengchuan', '123');
INSERT INTO `staff_info` VALUES ('38', '4', '熊婧', '女', '35', '安徽', '2342224234656575757', '2018-08-08 00:31:49', '0791-87875656', '13576567889', '12xxxx3@qq.com', '江西南昌', '67879567567', '2017-05-09 00:00:00', '本科', '  ', '2', 'xiongjing', '123');
INSERT INTO `staff_info` VALUES ('39', '4', '陈紫琪', '女', '35', '江西', '2342224234', '2018-08-08 00:31:49', '0791-87875656', '13657687689', 'wefdsfa@126.com', '江西南昌', '565768766', '2018-08-08 00:00:00', '专科', '   ', '2', 'chenziqi', '123');
INSERT INTO `staff_info` VALUES ('40', '4', '吴忠胜', '男', '35', '江西', '2333333333333', '2018-08-08 00:31:49', '0791-87875656', '13787323434', '355459999@qq.com', '江西南昌', '323234323', '2017-10-25 00:00:00', '本科', '  ', '2', 'wuzhongsheng', '123');
INSERT INTO `staff_info` VALUES ('41', '4', '郑瑶瑶', '女', '35', '天津', '2342224234656575757', '2018-08-08 00:31:49', '0791-85653435', '13787323434', 'sdfdsf@136.com', '江西南昌', '67879567567', '2017-07-06 00:00:00', '硕士', '   ', '2', 'zhengyaoyao', '123');
INSERT INTO `staff_info` VALUES ('42', '4', '史占鹏', '男', '35', '安徽', '23422242348888', '2018-08-08 00:31:49', '0791-65675787', '13576567889', '12xxxx3@qq.com', '江西南昌', '6789879079', '2017-07-31 00:00:00', '本科', '  ', '2', 'shizhanpeng', '123');
INSERT INTO `staff_info` VALUES ('43', '4', '胡建明', '男', '35', '江西', '23422242348888', '2018-08-08 00:31:49', '0791-87875656', '13787323434', 'sdfdsf@136.com', '江西南昌', '6789879079', '2017-08-24 00:00:00', '专科', '     ', '2', 'hujianming', '123');
INSERT INTO `staff_info` VALUES ('44', '4', '金建华', '男', '35', '天津', '2342224234', '2018-08-08 00:31:49', '0791-65675787', '13576051848', 'sdfdsf@136.com', '江西南昌', '67879567567', '2015-08-11 00:00:00', '本科', '  ', '2', 'jinjianhua', '123');
INSERT INTO `staff_info` VALUES ('45', '4', '兰洁', '女', '35', '江西', '2342224234', '2018-08-08 00:00:00', '0791-65675787', '13657687689', '343435463@qq.com', '江西南昌', '67879567567', '2018-08-31 00:00:00', '专科', '    ', '2', 'lanjie', '123');
INSERT INTO `staff_info` VALUES ('46', '4', '戴胜男', '女', '35', '安徽', '3625281979XXXXX665', '2018-08-08 00:00:00', '0791-87875656', '13576051848', 'sdfdsf@136.com', '江西南昌', '67879567567', '2017-08-25 00:00:00', '本科', '    ', '2', 'daishengnan', '123');
INSERT INTO `staff_info` VALUES ('49', '4', '随和', '男', '35', '天津', '3625281979XXXXXXXX', '2018-08-08 00:31:49', '0791-34355657', '13576567889', '12xxxx3@qq.com', '江西南昌', '5657687666', '2017-08-08 00:00:00', '博士', '   ', '2', 'suihe', '123');
INSERT INTO `staff_info` VALUES ('52', '4', '李隽', '女', '35', '天津', '2342224234', '2018-08-08 00:00:00', '0791-34355657', '13787323434', 'sdfdsf@136.com', '江西南昌', '67879567567', '2018-07-30 00:00:00', '本科', '  ', '2', 'lijun', '123');
INSERT INTO `staff_info` VALUES ('53', '4', '涂斌', '男', '35', '江西', '2342224234656575757', '2018-08-08 00:31:49', '0791-34355657', '13787323434', 'wefdsfa@126.com', '江西南昌', '67879567567', '2017-05-20 00:00:00', '博士', '  ', '2', 'tubin', '123');
INSERT INTO `staff_info` VALUES ('54', '4', '熊勇', '男', '35', '江西', '3625281979XXXXX6567', '2018-08-08 00:00:00', '0791-87875656', '13657687689', '355459999@qq.com', '江西南昌', '67879567567', '2017-05-03 00:00:00', '本科', '         ', '2', 'xiongyong', '123');
INSERT INTO `staff_info` VALUES ('55', '3', '纪翠玲', '女', '23', '江西', '2342224234656575757', '2018-05-30 00:00:00', '0791-34355657', '13576567889', 'wefdsfa@126.com', '江西南昌', '6789879079', '2018-06-15 00:00:00', '本科', '', '3', 'jicuiling', '123');
INSERT INTO `staff_info` VALUES ('56', '3', '朱琳', '女', '25', '江西', '2333333333333', null, '0791-65675787', '13787323434', '355459999@qq.com', '江西南昌', '67879567567', null, '本科', '', '3', 'zhulin', '123');
INSERT INTO `staff_info` VALUES ('57', '3', '刘萍', '女', '24', '江西', '2333333333333', null, '345465768', '13787323434', 'wefdsfa@126.com', '江西南昌', '6789879079', null, '本科', '', '3', 'liuping', '123');
INSERT INTO `staff_info` VALUES ('58', '3', '付豪', '男', '25', '江西', '2342224234656575757', null, '0791-34355657', '13576567889', 'wefdsfa@126.com', '江西南昌', '6789879079', null, '本科', '', '3', 'fuhao', '123');
INSERT INTO `staff_info` VALUES ('59', '3', '程鳞雅', '女', '24', '江西', '2333333333333', null, '0791-65675787', '13576567889', 'wefdsfa@126.com', '安徽宿州', '67879567567', null, '本科', '', '3', 'chenglinya', '123');
INSERT INTO `staff_info` VALUES ('60', '3', '孟辽远', '男', '29', '江西', '23422242348888', null, '0791-34355657', '13576567889', '355459999@qq.com', '江西南昌', '6789879079', null, '本科', '', '3', 'mengliaoyuan', '123');
INSERT INTO `staff_info` VALUES ('61', '3', '闫玉姣', '女', '33', '江西', '2323', null, '', '13576567889', '234243@qq.com', '', '', null, '本科', ' ', '3', 'yanyujiao', '123');
INSERT INTO `staff_info` VALUES ('62', '3', '郑金梅', '女', '25', '江西', '2333333333333', null, '', '13576567889', '24243242@qq.com', '', '', null, '本科', '  ', '3', 'zhengjinmei', '123');
INSERT INTO `staff_info` VALUES ('63', '3', '刘满满', '女', '25', '江西', '2342224234656575757', null, '12', '13576051848', '234243@qq.com', '', '', null, '本科', '', '3', 'liumanman', '123');
INSERT INTO `staff_info` VALUES ('64', '3', '曾美玲', '女', '25', '江西', '2342224234', null, '', '13576051848', '12xxxx3@qq.com', '', '', null, '本科', '曾美玲', '3', 'zenglingmei', '123');
INSERT INTO `staff_info` VALUES ('65', '3', '李宇', '男', '26', '江西', '1212', null, '', '1354678768', '212323@qq.com', '', '', null, '本科', '李宇 ', '3', 'liyu', '123');
INSERT INTO `staff_info` VALUES ('66', '3', '刘杰', '女', '25', '江西', '2333333333333', null, '', '13657687689', '343435463@qq.com', '', '', null, '本科', '刘杰', '3', 'liujie', '123');
INSERT INTO `staff_info` VALUES ('67', '4', '张彦', '男', '35', '江西', '23', null, '345465768', '13787323434', '234243@qq.com', '', '23', null, '本科', '', '2', 'zhangyan', '123');
INSERT INTO `staff_info` VALUES ('68', '4', '戴瑞轩', '女', '30', '江西', '23', null, '143565676', '13576051848', '7232343@qq.com', '', '', null, '本科', ' ', '2', 'dairuixuan', '123');
INSERT INTO `staff_info` VALUES ('69', '4', '曾继勇', '男', '32', '江西', '12', null, '212', '21', '234243@qq.com', '', '', null, '本科', '', '2', 'zengjiyong', '123');
INSERT INTO `staff_info` VALUES ('70', '4', '李长云', '男', '32', '江西', '23', null, '232', '4', '343435463@qq.com', '', '', null, '本科', '', '2', 'lichangyun', '123');
INSERT INTO `staff_info` VALUES ('71', '4', '陈诩', '男', '25', '江西', '2342224234656575757', null, '212', '2', 'sdfdsf@136.com', '23', '', null, '本科', '', '2', 'chenxu', '123');
INSERT INTO `staff_info` VALUES ('72', '4', '彭杰', '男', '26', '江西', '23', null, '0791-85653435', '12', '212323@qq.com', '34', '', null, '本科', '', '2', 'pengjie', '123');
INSERT INTO `staff_info` VALUES ('73', '4', '熊英', '女', '28', '江西', '232323', null, '34', '21', '34545999xx@qq.com', '23', '', null, '本科', '', '2', 'xiongying', '123');
INSERT INTO `staff_info` VALUES ('74', '4', '周洁', '女', '28', '江西', '232', null, '0791-85653435', '23', '212323@qq.com', '34', '', null, '本科', ' ', '2', 'zhoujie', '123');
INSERT INTO `staff_info` VALUES ('75', '4', '王伟', '男', '27', '江西', '232', null, '0791-232434523', '34', '212323@qq.com', '23', '', null, '本科', ' ', '2', 'wangwei', '123');
INSERT INTO `staff_info` VALUES ('76', '4', '万杜鹏', '男', '35', '江西', '23', null, '345465768', '235', '34545999xx@qq.com', '54', '', null, '本科', '', '2', 'wandupeng', '123');
INSERT INTO `staff_info` VALUES ('77', '4', '徐俊杰', '男', '35', '江西', '23', null, '33', '12', '212323@qq.com', '34', '', null, '本科', '', '2', 'xujunjie', '123');
INSERT INTO `staff_info` VALUES ('78', '4', '王宇轩', '男', '31', '江西', '232', null, '143565676', '23', '212323@qq.com', '43', '', null, '本科', '', '2', 'wangyuxuan', '123');
INSERT INTO `staff_info` VALUES ('79', '4', '吴雅林', '男', '36', '江西', '23', null, '32', '12', '212323@qq.com1', '212', '23', null, '博士', '', '2', 'wuyalin', '123');
INSERT INTO `staff_info` VALUES ('80', '4', '张平', '男', '31', '江西', '23', null, '4', '34', '212323@qq.com1', '23', '', null, '本科', '', '2', 'zhangping', '123');
INSERT INTO `staff_info` VALUES ('81', '4', '周亚琪', '男', '31', '江西', '2', null, '34', '3', '212323@qq.com', '23', '23', null, '本科', '', '2', 'zhouyaqi', '123');
...
CREATE TABLE `student_family_member` (
  ...
  `family_app` varchar(50) DEFAULT NULL COMMENT '称谓',
  `family_age` int(11) DEFAULT NULL,
  `family_zcmm` varchar(50) DEFAULT NULL COMMENT '政治面貌',
  `workplace` varchar(50) DEFAULT NULL COMMENT '何处工作任职',
  `reg_time` datetime DEFAULT NULL,
  `family_note` varchar(2000) DEFAULT NULL,
  PRIMARY KEY (`student_family_id`),
  KEY `student_id` (`student_id`),
  KEY `staff_id` (`staff_id`),
  CONSTRAINT `student_family_member_ibfk_1` FOREIGN KEY (`staff_id`) REFERENCES `staff_info` (`staff_id`),
  CONSTRAINT `student_family_member_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `student_info` (`student_id`)
...
CREATE TABLE `student_graduation_thesis` (
  ...
  `student_id` int(11) DEFAULT NULL,
  `staff_id` int(11) DEFAULT NULL,
  `paper_title` varchar(50) DEFAULT NULL,
  `paper_teacher` varchar(50) DEFAULT NULL COMMENT '称谓',
  `paper_start` varchar(100) DEFAULT NULL,
  `paper_time` datetime DEFAULT NULL COMMENT '政治面貌',
  `paper_score` varchar(20) DEFAULT NULL COMMENT '何处工作任职',
  `paper_comments` varchar(2000) DEFAULT NULL,
  `reg_time` datetime DEFAULT NULL,
  `paper_note` varchar(2000) DEFAULT NULL,
  PRIMARY KEY (`student_paper_id`),
  KEY `student_id` (`student_id`),
  KEY `staff_id` (`staff_id`),
  CONSTRAINT `student_graduation_thesis_ibfk_1` FOREIGN KEY (`staff_id`) REFERENCES `staff_info` (`staff_id`),
  CONSTRAINT `student_graduation_thesis_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `student_info` (`student_id`)
) ENGINE=InnoDB DEFAULT CHARSET=gb2312;

-- ----------------------------
-- Records of student_graduation_thesis
-- ----------------------------
...
CREATE TABLE `student_info` (
  ...
  `student_name1` varchar(50) DEFAULT NULL COMMENT '曾用名',
  `student_national` varchar(20) DEFAULT NULL,
  `student_birthday` varchar(50) DEFAULT NULL,
  `student_health` varchar(20) DEFAULT NULL,
  `student_native` varchar(20) DEFAULT NULL,
  `student_indate` varchar(20) DEFAULT NULL,
  `student_marital` varchar(20) DEFAULT NULL,
  `student_address` varchar(300) DEFAULT NULL,
  `student_post` varchar(20) DEFAULT NULL,
  `family_tellphone` varchar(50) DEFAULT NULL,
  `student_tellphone` varchar(50) DEFAULT NULL,
  `student_qq` varchar(20) DEFAULT NULL,
  `student_isleague` varchar(20) DEFAULT NULL,
  `student_join_time` varchar(50) DEFAULT NULL,
  `student_idcard` varchar(30) DEFAULT NULL,
  `student_before_school` varchar(50) DEFAULT NULL,
  `student_hobby` varchar(200) DEFAULT NULL,
  `student_school` varchar(50) DEFAULT NULL,
  `student_pro` varchar(50) DEFAULT NULL,
  `student_edu_sys` varchar(50) DEFAULT NULL,
  ...
  `student_hard` varchar(20) DEFAULT NULL,
  `student_loan` varchar(20) DEFAULT NULL,
  `student_muster` varchar(20) DEFAULT NULL,
  `student_project` double(4,1) DEFAULT '0.0',
  PRIMARY KEY (`student_id`),
  KEY `FK_Reference_16` (`class_id`),
  KEY `FK_Reference_8` (`staff_id`),
  CONSTRAINT `student_info_ibfk_2` FOREIGN KEY (`staff_id`) REFERENCES `staff_info` (`staff_id`),
  CONSTRAINT `student_info_ibfk_3` FOREIGN KEY (`class_id`) REFERENCES `class_info` (`class_id`)
...
CREATE TABLE `student_learn_experience` (
  ...
  `student_id` int(11) DEFAULT NULL,
  `staff_id` int(11) DEFAULT NULL,
  `learn_allyears` varchar(50) DEFAULT NULL COMMENT '起讫年月',
  `learn_school` varchar(50) DEFAULT NULL COMMENT '学校或机关名称',
  `learn_position` varchar(50) DEFAULT NULL COMMENT '学习或任职',
  `reg_time` datetime DEFAULT NULL COMMENT '登记时间',
  `learn_note` varchar(2000) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`student_learn_id`),
  KEY `staff_id` (`staff_id`),
  KEY `student_learn_experience_ibfk_1` (`student_id`),
  CONSTRAINT `student_learn_experience_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student_info` (`student_id`),
  CONSTRAINT `student_learn_experience_ibfk_2` FOREIGN KEY (`staff_id`) REFERENCES `staff_info` (`staff_id`)
...
CREATE TABLE `student_payment` (
  ...
  CONSTRAINT `student_payment_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student_info` (`student_id`),
  CONSTRAINT `student_payment_ibfk_2` FOREIGN KEY (`staff_id`) REFERENCES `staff_info` (`staff_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
...
CREATE TABLE `student_practice_skills` (
  ...
  `practice_address` varchar(100) DEFAULT NULL,
  `practice_content` varchar(2000) DEFAULT NULL,
  `practice_score` varchar(20) DEFAULT NULL,
  `reg_time` datetime DEFAULT NULL,
  `practice_note` varchar(2000) DEFAULT NULL,
  PRIMARY KEY (`student_practice_id`),
  KEY `student_id` (`student_id`),
  KEY `staff_id` (`staff_id`),
  CONSTRAINT `student_practice_skills_ibfk_1` FOREIGN KEY (`staff_id`) REFERENCES `staff_info` (`staff_id`),
  CONSTRAINT `student_practice_skills_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `student_info` (`student_id`)
) ENGINE=InnoDB DEFAULT CHARSET=gb2312;

-- ----------------------------
-- Records of student_practice_skills
-- ----------------------------
...
CREATE TABLE `student_write_grade` (
  ...
  `write_grade_xuenian` varchar(100) DEFAULT NULL,
  `write_grade_xueqi` varchar(100) DEFAULT NULL COMMENT '学期',
  `write_grade_type` varchar(20) DEFAULT NULL COMMENT '考试类型（考试、考查、报考）',
  PRIMARY KEY (`write_grade_id`),
  KEY `FK_Reference_14` (`student_id`),
  KEY `FK_Reference_15` (`staff_id`),
  KEY `discipline_id` (`discipline_id`),
  KEY `class_id` (`class_id`),
  CONSTRAINT `student_write_grade_ibfk_2` FOREIGN KEY (`staff_id`) REFERENCES `staff_info` (`staff_id`),
  CONSTRAINT `student_write_grade_ibfk_3` FOREIGN KEY (`student_id`) REFERENCES `student_info` (`student_id`),
  CONSTRAINT `student_write_grade_ibfk_4` FOREIGN KEY (`discipline_id`) REFERENCES `discipline_info` (`discipline_id`),
  CONSTRAINT `student_write_grade_ibfk_5` FOREIGN KEY (`class_id`) REFERENCES `class_info` (`class_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
...
CREATE TABLE `track_record_info` (
  ...
  CONSTRAINT `track_record_info_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student_info` (`student_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `upload_file` (
  ...
  PRIMARY KEY (`file_id`),
  KEY `staff_id` (`staff_id`),
  CONSTRAINT `upload_file_ibfk_1` FOREIGN KEY (`staff_id`) REFERENCES `staff_info` (`staff_id`)
